...
### 3) Визначити середню, мінімальну та максимальну ціни за завершені прийоми для кожного ветеринара, вказавши кількість завершених прийомів для кожного ветеринара
